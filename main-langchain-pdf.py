...
# Function to extract text from the PDF (You already have this)
import fitz
...
# Extract the PDF text (you can call this directly in your script)
...
# Load and check the PDF text (instead of loading from file)
try:
